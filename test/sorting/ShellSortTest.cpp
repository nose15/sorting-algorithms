...
class ShellSortTest : public testing::TestWithParam<std::vector<int32_t>> {};

TEST_P(ShellSortTest, TestAlgorithmCorrect) {
    std::vector<int32_t> nums = GetParam();
    int32_t *arr = nums.begin().base();
    size_t size = nums.size();

    Sorting::ShellSort<int32_t> shellSort(arr, size);
    int32_t *res = shellSort.sort();
